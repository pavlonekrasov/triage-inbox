...
/**
 * The desk's button. Hover is a background wash over 150 ms (fine pointers only, via the hover
 * variant); press scales to --press-scale over 100 ms, which reduced motion pins to 1.
 */
