...
export const contrastPairs: ContrastPair[] = [
  ...
  { label: "Muted text in draft bubble", fg: "--muted-foreground", bg: ["--card", "--brand-wash"], min: 4.5 },
  { label: "Muted text in sent bubble", fg: "--muted-foreground", bg: ["--bubble-out"], min: 4.5 },
  { label: "Sent label on wallpaper field B", fg: "--muted-foreground", bg: ["--field-b"], min: 4.5 },
  { label: "Sent label on wallpaper field A", fg: "--muted-foreground", bg: ["--field-a"], min: 4.5 },
  { label: "Ink day separator on service pill", fg: "--foreground", bg: ["--secondary"], min: 4.5 },
  { label: "Draft edge on card (dashed, 1px)", fg: "--brand-edge", bg: ["--card"], min: null },
  ...
  { label: "Checkbox edge on list pane", fg: "--muted-foreground", bg: ["--sidebar"], min: 3 },
  ...
  { label: "Violet composer label on strong glass over field C", fg: "--brand", bg: ["--field-c", "--glass-tint-strong"], min: 4.5 },
  { label: "Muted composer text on strong glass over field C", fg: "--muted-foreground", bg: ["--field-c", "--glass-tint-strong"], min: 4.5 },
  { label: "Not sent label on wallpaper field C", fg: "--risk-high", bg: ["--field-c"], min: 4.5 },
  { label: "Not sent label on wallpaper field B", fg: "--risk-high", bg: ["--field-b"], min: 4.5 },
  { label: "Drafting prefix on list pane", fg: "--brand", bg: ["--sidebar"], min: 4.5 },
  { label: "Drafting prefix on selected row", fg: "--brand", bg: ["--sidebar", "--accent"], min: 4.5 },
  { label: "Typing dots on draft wash", fg: "--brand", bg: ["--card", "--brand-wash"], min: 3 },
  { label: "Sparkline line on quality sheet", fg: "--muted-foreground", bg: ["--popover"], min: 3 },
  { label: "Today's sparkline dot on quality sheet", fg: "--foreground", bg: ["--popover"], min: 3 },
